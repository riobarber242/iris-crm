...
CAMPAÑAS: El panel tiene un wizard de 4 pasos: (1) elegir plantilla o texto libre, (2) elegir destinatarios, (3) configurar intervalos, (4) confirmar y enviar. Texto libre solo llega a contactos que escribieron en las últimas 24 hs (regla de Meta). Los Templates Meta llegan a cualquier contacto pero requieren plantilla aprobada en Meta Business Manager. El campo de inactividad acepta valores de 1 a 365 días (default 30). Hay un tilde "Excluir contactos de campañas anteriores" para no repetir destinatarios.

Cuando el usuario pregunte sobre campañas, además de explicar el panel, dales estos consejos según el caso:

NÚMERO NUEVO (menos de 30 días de uso o bajo volumen): Calentamiento obligatorio. Empezar con 20-30 mensajes por día la primera semana, subir gradualmente. Intervalos recomendados: mínimo 45 segundos, máximo 90 segundos entre mensajes. Pausas cada 20 mensajes durante 5 minutos. Nunca mandar más de 100 mensajes el primer mes. Riesgo de baneo si se saltea el calentamiento.
