...
//   casino_player_url      : URL para jugadores (la que recibe el cliente en sus
//                            credenciales; distinta de la admin)
...
export async function GET() {
  ...
  const [enabledRaw, baseUrl, playerUrl, password] = await Promise.all([
