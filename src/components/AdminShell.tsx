...
export function AdminShell({ children, initialPlan }: { children: ReactNode; initialPlan?: string | null }) {
  ...
  // Paleta del logo. Lo ÚNICO que cambia en Lite es el marco del ícono, que pasa
  // de naranja a cian. El interior (círculo + rayo) sigue verde lima, "IRIS"
  // blanco y la palabra del plan naranja, igual que en cualquier otro plan.
  const esLite    = normalizePlan(plan) === 'lite';
  const logoMarco = esLite ? '#00BBDD' : '#FF5500';   // borde del cuadrado
      ...
      <header className="app-header" style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', minWidth: 0, overflow: 'visible' }}>
          ...
          <svg className="logo-desktop" width="220" height="66" viewBox="0 0 680 200" xmlns="http://www.w3.org/2000/svg" style={{ flexShrink: 0 }}>
            <rect x="20" y="18" width="148" height="148" rx="26" fill="#111" stroke={logoMarco} strokeWidth="7"/>
          ...
          <svg className="logo-mobile" width="52" height="52" viewBox="0 0 188 188" xmlns="http://www.w3.org/2000/svg" style={{ flexShrink: 0 }}>
            <rect x="4" y="4" width="180" height="180" rx="32" fill="#111" stroke={logoMarco} strokeWidth="8"/>
